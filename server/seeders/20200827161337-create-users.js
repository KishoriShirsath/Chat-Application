// Seeders, on the other hand, are used to insert or populate initial or dummy data into the database.
// Seeders help you create consistent and predefined data in your database that can be used for testing, populating default values.
"use strict";
